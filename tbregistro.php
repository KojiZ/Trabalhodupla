    ...
    <div class="card-body">
      <table class="table">
        ...
        <?php
          ...
          $select = $conn->prepare("SELECT idregistros, idcliente, idformapagamento, idservico, idadm, prazoEntrega, valorContratado, valorEntrada, ativo, cadastro, alteracao FROM servico");
